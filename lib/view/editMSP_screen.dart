...
class EditMSPScreen extends StatelessWidget {
    final String batchname,date,reason,id,batchId,tutorId,batchEnd;
   EditMSPScreen({super.key, required this.batchname, required this.date, required this.reason, required this.id, required this.batchId, required this.tutorId, required this.batchEnd});
        ...
        style: const TextStyle(
          ...
          color: Colors.black,
            ...
            SingleButton(
              btnName: 'Add',
              onTap: () {
              mspController.editMSP(context,id,tutorId,batchId);
              },
            )
          ],
        ),
