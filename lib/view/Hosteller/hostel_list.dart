      ...
      setState(() {
        ...
        if (searchTerm.isNotEmpty) {
          filteredList = filteredListSearch!.where((classItem) {
            return classItem.hostelName!
                    .toLowerCase()
                    .contains(searchTerm.toLowerCase()) ||
                classItem.hostelType!
                    .toLowerCase()
                    .contains(searchTerm.toLowerCase()) ||
                classItem.hostelPriceDetails!.price!
                    .toString()
                    .toLowerCase()
                    .contains(searchTerm.toLowerCase()) ||
                classItem.hostelPriceDetails!.roomType!
                    .toLowerCase()
                    .contains(searchTerm.toLowerCase()) ||
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              _buildRow('Hostel name',
                                                  hostel.hostelName, context),
                                              _buildRow('Hostel type',
                                                  hostel.hostelType, context),
                                              _buildRow('category',
                                                  hostel.categories, context),
                                              hostel.hostelPriceDetails != null
                                                  ? _buildRow(
                                                      'Room type',
                                                      hostel.hostelPriceDetails!
                                                          .roomType,
                                                      context)
                                              ...
                                              hostel.hostelPriceDetails != null
                                                  ? _buildRow(
                                                      'Price',
                                                      '₹ ${hostel!.hostelPriceDetails!.price.toString()} /month' ??
                                                          '',
                                                      context)
                                                  : const SizedBox.shrink(),
                                              _buildRow(
