...
class HostelEnrollmentScreen extends StatelessWidget {
  ...
  final String? firstname, lastname, wowid,lastWord;
   ...
   HostelEnrollmentScreen({super.key, required this.type, required this.fromBottomNav, this.firstname, this.lastname, this.wowid, this.lastWord, this.onDashBoardBack}): controller = Get.put(HostelEnrollementController(),permanent: true);
