...
class AddUserRatingsScreen extends StatefulWidget {
  final String? firstName, lastName, address, email, phNo,tutorId,batchId,courseId;

  const AddUserRatingsScreen(
      {Key? key, this.firstName, this.lastName, this.address, this.email, this.phNo, this.tutorId, this.batchId, this.courseId})
      : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text(
              'Ratings & Reviews',
              style: GoogleFonts.nunito(fontWeight: FontWeight.w700, color: Colors.black,fontSize: 16),
            ),
                ...
                children: [
                  Center(
                    child: Text(
                      ...
                      style: GoogleFonts.nunito(fontWeight: FontWeight.w400, color: Colors.black),
                    ),
                  ),
                  SizedBox(
                    height: 60,
                    child: Center(
                      child: RatingBar.builder(
                        ...
                        onRatingUpdate: (rating) async {
                          ...
                          await updateSelectedSubcategories(rating.toInt());
                        },
                      ),
                    ),
                  ),
                            ...
                            children: [
                              Checkbox(
                                ...
                                onChanged: (bool? value) {
                                  setState(() {
                                    selectedCheckboxes[subcategory] = value ?? false;
                                  });
                                },
                              ),
                              Text(subcategory),
