class validateAndLoginParentModal {
	...
	validateAndLoginParentModal({this.statusCode, this.success, this.parentAccount, this.parentDetail, this.parentToken, this.message, this.userDetail});

	validateAndLoginParentModal.fromJson(Map<String, dynamic> json) {
		statusCode = json['statusCode'];
		success = json['success'];
		parentAccount = json['parentAccount'];
		parentDetail = json['parentDetail'] != null ? new ParentDetail.fromJson(json['parentDetail']) : null;
...
class UserDetail {
	...
	UserDetail({this.location, this.sId, this.firstName, this.lastName, this.wowId, this.email, this.dob, this.phoneNumber, this.pincode, this.userType, this.otp, this.accountVerificationToken, this.accountVerified, this.accountSetup, this.doorNo, this.street, this.city, this.state, this.country, this.idProof, this.idProofLabel, this.idProofFilename, this.idProofUrl, this.profileFilename, this.profileUrl, this.latitude, this.longitude, this.qrCodeUrl, this.isActive, this.isDeleted, this.createdAt, this.token, this.address, this.rolesId, this.rolesTypeId, this.fcmToken, this.parentPhoneNumber});
