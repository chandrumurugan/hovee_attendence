...
class GetGroupedEnrollmentByAttendanceModel {
    GetGroupedEnrollmentByAttendanceModel({
    ...
    factory GetGroupedEnrollmentByAttendanceModel.fromJson(Map<String, dynamic> json){ 
        return GetGroupedEnrollmentByAttendanceModel(
            statusCode: json["statusCode"],
