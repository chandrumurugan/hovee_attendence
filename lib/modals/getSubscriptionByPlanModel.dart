class GetSubscriptionByPlanModel {
    GetSubscriptionByPlanModel({
    ...
    factory GetSubscriptionByPlanModel.fromJson(Map<String, dynamic> json){ 
        return GetSubscriptionByPlanModel(
